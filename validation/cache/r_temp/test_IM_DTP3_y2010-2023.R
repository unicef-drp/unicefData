...
tryCatch({
    df <- unicefData(indicator = "IM_DTP3", metadata = "light", year = "2010:2023")

    if (nrow(df) > 0) {
        write.csv(df, "C:/GitHub/myados/unicefData-dev/validation/cache/r/IM_DTP3_y2010-2023.csv", row.names = FALSE, fileEncoding = "UTF-8")
