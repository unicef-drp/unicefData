...
tryCatch({
    df <- unicefData(indicator = "CME_MRY0", metadata = "light", year = "2000:2023")

    if (nrow(df) > 0) {
        write.csv(df, "C:/GitHub/myados/unicefData-dev/validation/cache/r/CME_MRY0_y2000-2023.csv", row.names = FALSE, fileEncoding = "UTF-8")
