...
tryCatch({
    df <- unicefData(indicator = "NT_ANT_HAZ_NE2", metadata = "light", year = "2015:2023")

    if (nrow(df) > 0) {
        write.csv(df, "C:/GitHub/myados/unicefData-dev/validation/cache/r/NT_ANT_HAZ_NE2_y2015-2023.csv", row.names = FALSE, fileEncoding = "UTF-8")
