...
tryCatch({
    df <- unicefData(indicator = "ED_ANAR_L02", metadata = "light", year = "2015:2023")

    if (nrow(df) > 0) {
        write.csv(df, "C:/GitHub/myados/unicefData-dev/validation/cache/r/ED_ANAR_L02_y2015-2023.csv", row.names = FALSE, fileEncoding = "UTF-8")
