...
capture noisily unicefdata, indicator(ECON_GVT_EXP_PTGDP) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/ECON_GVT_EXP_PTGDP.csv", replace
