...
capture noisily unicefdata, indicator(PV_CHLD_INCM-PL) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/PV_CHLD_INCM-PL.csv", replace
