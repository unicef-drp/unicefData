...
capture noisily unicefdata, indicator(MNCH_ANC4) nosparse nofilter clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/MNCH_ANC4_nofilter.csv", replace
