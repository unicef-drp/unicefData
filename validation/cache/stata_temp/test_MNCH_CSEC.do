...
capture noisily unicefdata, indicator(MNCH_CSEC) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/MNCH_CSEC.csv", replace
