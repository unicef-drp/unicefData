...
capture noisily unicefdata, indicator(NT_BF_EXBF) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/NT_BF_EXBF.csv", replace
