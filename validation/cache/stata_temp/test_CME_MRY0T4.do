...
capture noisily unicefdata, indicator(CME_MRY0T4) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/CME_MRY0T4.csv", replace
