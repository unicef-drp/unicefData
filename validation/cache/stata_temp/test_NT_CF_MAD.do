...
capture noisily unicefdata, indicator(NT_CF_MAD) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/NT_CF_MAD.csv", replace
