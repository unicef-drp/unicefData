...
capture noisily unicefdata, indicator(IM_RCV1) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/IM_RCV1.csv", replace
