...
capture noisily unicefdata, indicator(PT_F_20-24_MRD_U18) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/PT_F_20-24_MRD_U18.csv", replace
