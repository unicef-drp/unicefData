...
capture noisily unicefdata, indicator(PT_CHLD_Y0T4_REG) nosparse clear
...
if _rc == 0 {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData-dev/validation/cache/stata/PT_CHLD_Y0T4_REG.csv", replace
