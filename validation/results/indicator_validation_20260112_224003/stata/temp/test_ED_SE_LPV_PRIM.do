...
unicefdata, indicator(ED_SE_LPV_PRIM)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/success/ED_SE_LPV_PRIM.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/failed/ED_SE_LPV_PRIM.error", write replace
