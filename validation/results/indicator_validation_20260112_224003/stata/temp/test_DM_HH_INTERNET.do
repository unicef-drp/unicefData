...
if _rc == 0 {
    ...
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/success/DM_HH_INTERNET.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/failed/DM_HH_INTERNET.error", write replace
