...
unicefdata, indicator(NT_CF_OTHER_FV)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/success/NT_CF_OTHER_FV.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/failed/NT_CF_OTHER_FV.error", write replace
