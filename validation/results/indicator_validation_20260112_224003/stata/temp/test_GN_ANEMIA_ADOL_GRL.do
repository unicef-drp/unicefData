...
if _rc == 0 {
    ...
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/success/GN_ANEMIA_ADOL_GRL.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_224003/stata/failed/GN_ANEMIA_ADOL_GRL.error", write replace
