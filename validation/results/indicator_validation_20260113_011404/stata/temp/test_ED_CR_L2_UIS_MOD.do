...
unicefdata, indicator(ED_CR_L2_UIS_MOD)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/ED_CR_L2_UIS_MOD.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/ED_CR_L2_UIS_MOD.error", write replace
