...
if _rc == 0 {
    ...
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/PT_F_GE15_SX_V_PTNR_12MNTH.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/PT_F_GE15_SX_V_PTNR_12MNTH.error", write replace
