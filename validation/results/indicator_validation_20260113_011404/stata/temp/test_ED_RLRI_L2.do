...
unicefdata, indicator(ED_RLRI_L2)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/ED_RLRI_L2.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/ED_RLRI_L2.error", write replace
