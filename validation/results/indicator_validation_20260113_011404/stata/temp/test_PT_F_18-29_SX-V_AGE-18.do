...
unicefdata, indicator(PT_F_18-29_SX-V_AGE-18)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/PT_F_18-29_SX-V_AGE-18.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/PT_F_18-29_SX-V_AGE-18.error", write replace
