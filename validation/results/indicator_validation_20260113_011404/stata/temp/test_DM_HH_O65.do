...
unicefdata, indicator(DM_HH_O65)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/DM_HH_O65.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/DM_HH_O65.error", write replace
