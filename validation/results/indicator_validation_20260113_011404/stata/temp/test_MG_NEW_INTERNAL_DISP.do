...
unicefdata, indicator(MG_NEW_INTERNAL_DISP)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/MG_NEW_INTERNAL_DISP.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/MG_NEW_INTERNAL_DISP.error", write replace
