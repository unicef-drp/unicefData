...
unicefdata, indicator(PT_M_15-17_SX-V)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/success/PT_M_15-17_SX-V.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260113_011404/stata/failed/PT_M_15-17_SX-V.error", write replace
