...
capture {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_134236/stata/success/COD_CARDIOMYOPATHY_MYOCARDITIS_ENDOCARDITIS.csv", replace
