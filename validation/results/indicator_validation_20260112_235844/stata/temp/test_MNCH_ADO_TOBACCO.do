...
unicefdata, indicator(MNCH_ADO_TOBACCO)   clear

if _rc == 0 {
    qui describe
    local nobs = r(N)
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_235844/stata/success/MNCH_ADO_TOBACCO.csv", replace
    ...
    file open ferr using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_235844/stata/failed/MNCH_ADO_TOBACCO.error", write replace
