...
capture {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_164439/stata/success/TRGT_2030_ED_READ_L1.csv", replace
