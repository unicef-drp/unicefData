...
capture {
    ...
    if `nobs' > 0 {
        export delimited using "C:/GitHub/myados/unicefData/validation/results/indicator_validation_20260112_164439/stata/success/COD_GALLBLADDER_AND_BILIARY_DISEASES.csv", replace
