...
## [2.4.1] - 2026-04-20 (Stata)

### Fixed

- `build_dataflow_metadata.py` now sets `Accept-Language: en` via
  `urllib.request.Request` on all SDMX API calls — prevents non-English
  indicator names in Stata's YAML metadata generated by the weekly sync
  (fixes #45)
- Weekly metadata-sync GitHub Actions workflow stabilised: stash guard
  prevents the recurring `git checkout` conflict; issue-creation dedup
  prevents repeated failure tickets (fixes #65 #66 #68 #69 #75 #80)
