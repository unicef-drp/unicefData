...
PURPOSE:
    ...
    Provides reusable utilities for the unicefdata package.

STRUCTURE:
    1. Imports - External dependencies
    2. Validation Functions - validate_country_codes, validate_year_range, validate_indicator_code
    3. Data Cleaning - clean_dataframe
    4. Data Loading - load_country_codes
    5. Data Enrichment - merge_with_country_names
    6. Data Transformation - pivot_wide
    7. Data Analysis - calculate_growth_rate
    8. Reference Data - get_country_regions, get_income_groups, get_continents
